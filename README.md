...
Authentication and internal dashboard template. Covers email/password auth, OAuth (Google, GitHub), magic links, session management, protected routes, and a clean admin dashboard UI. Works as a standalone app or as a starting point inside a larger SaaS product.
